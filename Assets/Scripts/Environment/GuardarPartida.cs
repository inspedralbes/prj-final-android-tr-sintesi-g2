...
public class GuardarPartida : MonoBehaviour
{
    ...
    private string apiUrl = "http://localhost:3002"; // Cambia esto si usas otra URL
    ...
    private IEnumerator SaveCheckpointRequest(string nickname, float x, float y, int health, int coins)
    {
        ...
        var data = new CheckpointData()
        {
            ...
            health = health,
            coins = coins,
            level = SceneManager.GetActiveScene().name // 🔹 Escena actual
...
public class CheckpointData
{
    ...
    public int health;
    public int coins;
    public string level; // 🔹 Nueva propiedad para la escena actual
